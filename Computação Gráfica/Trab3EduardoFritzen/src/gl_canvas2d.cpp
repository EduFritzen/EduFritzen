...
//conjunto de cores predefinidas.
float Colors[28][3]=
{
    {0, 0, 0}, //Black
    {0.5, 0.5, 0.5}, //Gray
...
void CV::point(std::vector<Ponto> pontos)
{
   glBegin(GL_POINTS);
...
void CV::line(Ponto ponto1, Ponto ponto2 )
{
   glBegin(GL_LINES);
      glVertex2d(ponto1.x, ponto1.y);
      glVertex2d(ponto2.x, ponto2.y);
   glEnd();
}

void CV::line( std::vector<Ponto> pontos )
